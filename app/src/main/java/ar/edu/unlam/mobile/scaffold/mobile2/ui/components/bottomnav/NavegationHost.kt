...
import ar.edu.unlam.mobile.scaffold.mobile2.ui.screens.Inicio
import ar.edu.unlam.mobile.scaffold.mobile2.ui.screens.MyGoogleMap
...
fun NavegationHost(
    ...
    NavHost(
        ...
        composable(ItemsMenuDW.PantallaGoogle.ruta){
            MyGoogleMap()
        }
