...
import ar.edu.unlam.mobile.scaffold.mobile2.navigationbottom.ItemsMenu
...
fun Tabs_Principal(viewModel: NewsViewModel, navController: NavHostController) {
    val tabs = listOf(
        TabsItem.ItemGeneral(viewModel, navController),
        TabsItem.ItemBusiness(viewModel, navController),
        TabsItem.ItemEntertainment(viewModel, navController),
        TabsItem.ItemHealth(viewModel, navController),
        TabsItem.ItemScience(viewModel, navController),
        TabsItem.ItemSports(viewModel, navController),
        TabsItem.ItemTechnology(viewModel, navController),
