...
fun NoticaScreen(new: New, navController: NavHostController) {
    NewDetailScreen(new, navController)
...
@SuppressLint("UnusedMaterialScaffoldPaddingParameter")
@Composable
fun NewDetailScreen(new: New, navController: NavHostController) {
...
// defini un popup para mostrar las opciones
                    DropdownMenu(
                        expanded = isMenuOpen,
                        ...
                        DropdownMenuItem(onClick = {
                            isMenuOpen = false
                            //Tenemos que implementar una navegacion a la pantalla compartir
                        }) {
                            Text("Compartir")
                        }
                        DropdownMenuItem(onClick = {
                            isMenuOpen = false
                            abrirLink(context, new.url!!)
                        }) {
                            Text("Abrir en el navegador")
                        }
                        DropdownMenuItem(onClick = {
                            isMenuOpen = false
                            //Hay que realizar la funcion para abrir en el mapa la ubicacion de la notica
                        }) {
                            Text("Ver en el mapa")
                        }
                    }
